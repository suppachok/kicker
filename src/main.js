...
const myBot =['u5491e4a1ae62ad396fa80927d9518f6e'];
...
\n";
        ...
        if(txt === 'กุ้งอยู่ปะ' && this.stateStatus.kick == 1 && isAdminOrBot(seq.from_) && seq.toType == 2) {
            let { listMember } = await this.searchGroup(seq.to);
            for (var i = 0; i < listMember.length; i++) {
        ...
        }else if(txt === 'กุ้งอยู่ปะ' && !isAdminOrBot(seq.from_) && seq.toType == 2){this._sendMessage(seq,"Not permitted !");}
